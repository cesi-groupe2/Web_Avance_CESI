...
import (
	...
	"github.com/cesi-groupe2/Web_Avance_CESI/backend/microServPayment/docs" // docs is generated by Swag CLI, you have to import it.
)
...
func main() {
	...
	docs.SwaggerInfo.Host = microServBase.InitSwagger(paymentGroup, address, port)
